...
<body>
    ...
    <main class="content-wrapper">
        <div class="container-fluid">
            <h1 class="text_main-title">День 4 лагеря GoGame</h1>
            <hr>
                <h4>в 20:30 | Лекция "Моделирование и анимация. Работа со звуком"</h4>
                <br>
                <div>
                ...
                <br> 
                <br>  
                <h4>В 20:30 | Практика "Программирование в Unity ЧАСТЬ 1"</h4>
                <br> 
                <h5></h5>
                ...
                <br>
                <div>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/JfzI6F3pt_s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                <br>
                <h4>Практика "Программирование проекта в Unity ЧАСТЬ 2"</h4>
                <br>  
                <div>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/5nRCktoW3FU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                <br>        
                    ...
                    <div class="jumbotron">
                        ...
                        <br>1) Реализовать препятсвие, в котором есть триггер (Фото)<kbd>1 балл</kbd>
                        <br>2) Сделать меню уровней и несколько уровней игры. Добавить возможность перехода между меню и уровнями (Фото/видео + .unitypackage) <kbd>2 балла</kbd>
                        <br>
                        <br><strong>Повышенная сложность:</strong> Придумать интересное припятсвие для уровня и реализовать его (Фото/видео + .unitypackage)<kbd>2 балла</kbd>
